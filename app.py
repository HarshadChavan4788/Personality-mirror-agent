...
# Header
# ---------------------------------------------------------
st.markdown("<h1 style='font-size:2.5em; color:#222;'>🪞 Personality Mirror Agent</h1>", unsafe_allow_html=True)
    ...
    if not any(answers):
        ...
        with st.spinner("Running multi-agent analysis..."):
            try:
                ...
                st.markdown(f"<div style='color:#222;font-size:1.1em;'>{result.get('summary', '—')}</div>", unsafe_allow_html=True)
